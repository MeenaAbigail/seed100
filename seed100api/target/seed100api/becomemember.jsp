		...
		<div class="main">
			...
			<div class="wrapper">
				...
				<ul id="menu">
					...
					<li><a href="makedonations.jsp">Donate</a></li>
				</ul>
				</nav>
			</div>
			</header>
			...
			<div class="wrapper">
				<div class="become_member">
					<div class="line1">
						<form action="rest/member/registration" method="POST">
							<ul>
								...
								<li><label>*Who referred you :</label></li>
								<li><input type="text" name="whoReferedYou" size="50" /></li>
