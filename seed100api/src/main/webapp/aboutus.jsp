...
<body id="page2">
	<div class="body1">
		<div class="main">
			...
			<div class="wrapper">
				<h1>
					<a href="index.jsp" id="logo">SEED100</a>
				</h1>
				<nav>
				<ul id="top_nav">
				...
				<ul id="menu">
					...
					<li><a href="makeonations.jsp">Donate</a></li>
				</ul>
				</nav>
			</div>
			</header>
			...
			<div class="wrapper">
				<div class="box12">
					<div class="line1">
						<form>
							<h2>SEED100</h2>
							<p>Seed100 is a registered charitable trust which supports the education of girl children in India.
...
which is to help educate girl children who can't afford it themselves.

If you would like to know more about us please do get in touch with us at mail@seed100.org. We will be more than happy to help you.
							</p>
						</form>
